...
export default function WomenCategoryPage() {
  ...
  const subcategories = [...new Set(products.filter(p => p.category === 'women').map(p => p.subcategory))];
          ...
          <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-3/4">
              <div class="flex justify-between items-center mb-6">
                <p class="text-gray-600">${products.filter(p => p.category === 'women').length} products</p>
