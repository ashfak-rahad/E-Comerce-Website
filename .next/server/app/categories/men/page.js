(()=>{var e={};e.id=587,e.ids=[587],e.modules={7849:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external")},2934:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external.js")},5403:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external")},4580:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external.js")},4749:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external")},5869:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},9706:(e,t,i)=>{"use strict";i.r(t),i.d(t,{GlobalError:()=>o.a,__next_app__:()=>m,originalPathname:()=>p,pages:()=>d,routeModule:()=>u,tree:()=>l});var r=i(482),s=i(9108),a=i(2563),o=i.n(a),n=i(8300),c={};for(let e in n)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(c[e]=()=>n[e]);i.d(t,c);let l=["",{children:["categories",{children:["men",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(i.bind(i,1567)),"C:\\cursor ai\\e-comerce-website\\src\\app\\categories\\men\\page.tsx"]}]},{}]},{}]},{layout:[()=>Promise.resolve().then(i.bind(i,1342)),"C:\\cursor ai\\e-comerce-website\\src\\app\\layout.tsx"],"not-found":[()=>Promise.resolve().then(i.t.bind(i,9361,23)),"next/dist/client/components/not-found-error"]}],d=["C:\\cursor ai\\e-comerce-website\\src\\app\\categories\\men\\page.tsx"],p="/categories/men/page",m={require:i,loadChunk:()=>Promise.resolve()},u=new r.AppPageRouteModule({definition:{kind:s.x.APP_PAGE,page:"/categories/men/page",pathname:"/categories/men",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:l}})},6534:(e,t,i)=>{Promise.resolve().then(i.t.bind(i,2583,23)),Promise.resolve().then(i.t.bind(i,6840,23)),Promise.resolve().then(i.t.bind(i,8771,23)),Promise.resolve().then(i.t.bind(i,3225,23)),Promise.resolve().then(i.t.bind(i,9295,23)),Promise.resolve().then(i.t.bind(i,3982,23))},5303:()=>{},1567:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>s});var r=i(636);function s(){let e=r.R.filter(e=>"men"===e.category).map(e=>`
      <div class="card">
        <img 
          src="${e.image}" 
          alt="${e.name}" 
    ...
    `).join(""),t=[...new Set(r.R.filter(e=>"men"===e.category).map(e=>e.subcategory))].map(e=>`<button class="px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-100">${e}</button>`).join("");return`
          ...
          <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-3/4">
              <div class="flex justify-between items-center mb-6">
                <p class="text-gray-600">${r.R.filter(e=>"men"===e.category).length} products</p>
